...
function rcube_webmail() {
        ...
        if (form) {
          ...
          // contacts/identities
            ...
            $('input.placeholder').each(function () {
              if (this.value == this._placeholder) this.value = '';
            });
          }
  ...
  this.upload_progress_start = function (action, name) {
    setTimeout(function () {
          ref.http_request(action, {_progress: name});
        },
...
//        onSelect: function(dateText) { $(this).focus().val(dateText); }
  ...
  this.set_caret_pos = function (obj, pos) {
    ...
    } // catch Firefox exception if obj is hidden
  };
  ...
  this.tif_support_check = function () {
    window.setTimeout(function () {
      var img = new Image();
      img.onload = function () {
        ref.env.browser_capabilities.tif = 1;
      };
      img.onerror = function () {
        ref.env.browser_capabilities.tif = 0;
      };
  ...
  this.pdf_support_check = function () {
    ...
    window.setTimeout(function () {
      $('<object>').css({position: 'absolute', left: '-10000px'})
          ...
          .load(function () {
            ref.env.browser_capabilities.pdf = 1;
          })
          .error(function () {
            ref.env.browser_capabilities.pdf = 0;
          })
          .appendTo($('body'));
    }, 10);
